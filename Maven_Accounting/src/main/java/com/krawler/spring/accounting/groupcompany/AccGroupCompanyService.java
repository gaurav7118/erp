 ...
 * @author krawler
 */
public interface AccGroupCompanyService {
    ...
    public JSONObject saveGroupCompanyWizardSettings(JSONObject paramJobj) throws JSONException, ServiceException, SessionExpiredException;
}
