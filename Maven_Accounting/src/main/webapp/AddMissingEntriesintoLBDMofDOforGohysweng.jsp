...
<%
    ...
    try {
        ...
        while (rs.next()) {
            ...
            String queryproduct = "select dodid,productid,qty from tempdodidforgs ";
            ...
            while (rsp.next()) {
                ...
                if (rs9.next()) {
                    ...
                    String querybatch = "insert into newproductbatch (id,quantity,quantitydue,location,warehouse,transactiontype,product,isopening,ispurchase,company) values (?,?,?,?,?,27,?,'F','T',?)";
