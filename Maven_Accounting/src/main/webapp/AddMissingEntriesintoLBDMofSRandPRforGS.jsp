...
<%
    ...
    try {
        ...
        String moduleid = request.getParameter("moduleid"); //"caygroup";
        ...
        while (rs.next()) {
            ...
            String queryproduct = "select dodid,productid,qty from tempsrdidforgs ";
            ...
            while (rsp.next()) {
                ...
                String dodid = rsp.getString("dodid");
                ...
                if (rs9.next()) {
                    ...
                    if (!rs10.next()) {
                        ...
                        stmtlbmap.setString(3, dodid);
                        stmtlbmap.setString(4, batchId);
                        stmtlbmap.execute();
                        stmtlbmap.close();
                        out.println("<br><br> for grdetail " + dodid + "and for product " + productid + "qty " + qty + "inserted in to lbdm");
                        totalproductUpdationCnt++;
                    }
                } else {
                    String batchMapId = java.util.UUID.randomUUID().toString();
                    String querybatch = "insert into newproductbatch (id,quantity,quantitydue,location,warehouse,transactiontype,product,isopening,ispurchase,company) values (?,?,?,?,?,29,?,'F','T',?)";
                    ...
                    stmtlbmap.execute();
                    stmtlbmap.close();
                    out.println("<br><br> for grdetail new batch is created " + dodid + "and for product " + productid + "qty " + qty + "inserted in to lbdm");
                    totalproductUpdationCnt++;
                }
