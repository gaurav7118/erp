...
<%
    ...
    try {
        ...
        String query = "select id,columnpref from extracompanypreferences";
        ...
        while (rs.next()) {
            ...
            totalrec++;
            if (obj.has("gstamountdigitafterdecimal")) {
                continue;
            } else {

                obj.put("gstamountdigitafterdecimal", 2);
