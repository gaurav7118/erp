...
//        String dbName = "alfatech_12032015";
...
//        String password = "krawler";
        ...
        String querycash = "SELECT id, description FROM expenseggrdetails WHERE description IS NOT NULL";
        ...
        while (rscash.next()) {
            ...
            try {
                ...
                String updatepayment = "UPDATE expenseggrdetails SET description=?  where id=?";
