...
<%
    ...
    try {
        ...
        while (comprs.next()) {
            ...
            customQuery = "select expenseggrdetails.purchasejedid,expenseggrdetails.gstjedid,expenseggrdetails.company "
                    + "from expenseggrdetails inner join accjedetailcustomdata on expenseggrdetails.purchasejedid = accjedetailcustomdata.jedetailId and (expenseggrdetails.gstjedid  is not null "
                    + "and expenseggrdetails.gstjedid <> '' and (expenseggrdetails.gstjedid not in (select jedetailId from accjedetailcustomdata ))) "
                    + "where expenseggrdetails.company = ?";
            ...
            while (entrySet.next()) {
                 ...
                 */
                String purchasejedid = entrySet.getString("purchasejedid");
                ...
                stmtquery0.setString(2, purchasejedid);
