...
<%
    ...
    try {
        ...
        while (comprs.next()) {
            ...
            customQuery = "select grdetails.purchasejedid,grdetails.gstjedid,grdetails.company "
                    + "from grdetails inner join accjedetailcustomdata on grdetails.purchasejedid = accjedetailcustomdata.jedetailId and (grdetails.gstjedid  is not null "
                    + "and grdetails.gstjedid <> '' and (grdetails.gstjedid not in (select jedetailId from accjedetailcustomdata ))) "
                    + "where grdetails.company =?";
