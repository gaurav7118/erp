...
<%
    ...
    try {
        ...
        String requestedURL = uri.substring(0, uri.indexOf(servletBase)) + "/CommonFunctions/reCalculateInvoiceAmountDue.do";
        ...
        while (rscash.next()) {
            ...
            try {
                ...
                pw.print("cid=" + companyId + "&sendmail=" + sendmail+"&module="+module);
                pw.close();
