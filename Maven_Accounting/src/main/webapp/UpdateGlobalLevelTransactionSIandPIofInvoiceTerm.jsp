<%-- 
    Document   : UpdateGlobalLevelTransactionSIandPIofInvoiceTerm
...
<%
    ...
    try {
        ...
        String requestedURL = url.substring(0, url.indexOf(servletBase)) + "/CommonFunctions/updateGlobalLevelTransactionSIandPIofInvoiceTerm.do";
