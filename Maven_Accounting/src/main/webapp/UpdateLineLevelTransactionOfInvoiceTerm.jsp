<%-- 
    Document   : UpdateLineLevelTransactionOfInvoiceTerm
    Created on : Aug 2, 2018, 2:22:30 PM
    Author     : krawler
--%>
...
<%
    ...
    try {
        ...
        String requestedURL = url.substring(0, url.indexOf(servletBase)) + "/CommonFunctions/updateLineLevelTransactionOfInvoiceTerm.do";
