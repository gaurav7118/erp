...
//        }
        ...
        String queryproduct = "select id,name,availablequantity,unitOfMeasure,currency from product where company=? ";
        ...
        while (rsp.next()) {
            ...
            availablequantity = rsp.getDouble("availablequantity");
            uomid = rsp.getString("unitOfMeasure");
            currency = rsp.getDouble("currency");
            name = rsp.getString("name");
            
            availablequantity = openingQty - availablequantity;
            ...
            String InvId = "", in_stocUUID = "", isopening = "";
            double Invbaseuomquantity = 0.0, Invquantity = 0.0;
            String queryinvid = "select id,quantity,baseuomquantity,isopening from inventory where company=? and product= ? and newinv='T'";
            ...
            if (rs4.next()) {
                ...
                isopening = rs4.getString("isopening");
            }
            if (!StringUtil.isNullOrEmpty(InvId) && isopening.equalsIgnoreCase("F")) {
                ...
                stmtquery.setDouble(1, Invquantity +  availablequantity);
                stmtquery.setDouble(2, Invbaseuomquantity +  availablequantity);
                stmtquery.setString(3, InvId);
                stmtquery.executeUpdate();

            } else {
                InvId = java.util.UUID.randomUUID().toString();
                String queryInv = "insert into inventory(id,product,quantity,baseuomquantity,actquantity,baseuomrate,uom,description,carryin,defective,newinv,company,updatedate,deleteflag) values (?,?,?,?,?,?,?,'','T','F','F',?,?,'F')";
                PreparedStatement stmtInv = conn.prepareStatement(queryInv);
                stmtInv.setString(1, InvId);
                stmtInv.setString(2, productId);
                stmtInv.setDouble(3, availablequantity);
                stmtInv.setDouble(4, availablequantity);
                stmtInv.setDouble(5, availablequantity);
            ...
            if (!StringUtil.isNullOrEmpty(batchId)) {
                ...
                stmtforUpdate.setDouble(1, availablequantity);
                stmtforUpdate.setDouble(2, availablequantity);
                ...
                stmtforlocUpdate.setDouble(1, availablequantity);
                ...
                if (updatecount == 0) {
                    ...
                    stmtlbmap.setDouble(2, availablequantity);
                ...
                stmtb.setDouble(2, availablequantity);
                stmtb.setDouble(3, availablequantity);
            ...
            if (rsstock.next()) {
                ...
                in_stocUUID = java.util.UUID.randomUUID().toString();
                ...
                stmtquery2.setString(1, in_stocUUID);
                stmtquery2.setString(2, productId);
                stmtquery2.setString(3, storeId);
                stmtquery2.setString(4, locationid);
                stmtquery2.setString(5, "");
                stmtquery2.setString(6, null);
                stmtquery2.setString(7, companyId);
                stmtquery2.setDouble(8, availablequantity);
                stmtquery2.setString(9, bbfrom);
                stmtquery2.setString(10, bbfrom);
                stmtquery2.execute();
                stmtquery2.close();
            }
            ...
            stmt5.setDouble(7, availablequantity); //qty 
            ...
            stmt5.setInt(12, 1); // opening stock :0 , stock In : 1 .Stock out : 2 
            ...
            smd.setDouble(6, availablequantity);
            smd.execute();
            smd.close();

            cnt++;
            
//            out.println("<br><br> Product : " + name + " Quantity :" +availablequantity );
        }
        int count = cnt - 1;
