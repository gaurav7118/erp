...
function callCustomConsolidationBalanceSheetReportTab(templateid,templatetitle,statementType){
    ...
    if(!panel){// If panel is already not open
        Wtf.Ajax.requestEx({
            ...
            if(response.success){  
                panel= new Wtf.account.consolidationCustomBalanceSheetReportTab({
                    id:'consolidationCustomBalanceSheetReportTab',
                    layout:'fit',
                    border: false,
...
Wtf.account.consolidationCustomBalanceSheetReportTab = function (config){
    ...
    Wtf.account.consolidationCustomBalanceSheetReportTab.superclass.constructor.call(this, config);
}

Wtf.extend(Wtf.account.consolidationCustomBalanceSheetReportTab,Wtf.Panel,{
    onRender:function(config){
        Wtf.account.consolidationCustomBalanceSheetReportTab.superclass.onRender.call(this, config);
        this.add({
            region: 'center',
            border: false,
    ...
    initComponent:function(config){
        Wtf.account.consolidationCustomBalanceSheetReportTab.superclass.initComponent.call(this, config);
        //Create Button
         this.createButton();
    ...
    createStore:function(recordsArray){
        ...
        this.store=new Wtf.data.Store({
            ...
            url: "ACCReports/getCustomConsolidationBalanceSheetReport.do",
            baseParams:{
...
//        WtfComMsgBox(29,4,true)
    ...
    createButton:function(){
        ...
        this.expButton=new Wtf.exportButton({
            ...
            get:Wtf.autoNum.consolidationCustomBalanceSheet,
