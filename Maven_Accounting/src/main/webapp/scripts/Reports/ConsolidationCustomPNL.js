...
function callCustomConsolidationPNLReportTab(templateid,templatetitle,statementType){
    var panel = Wtf.getCmp("consolidationPNLReportTab");
    if(!panel){// If panel is already not open
        Wtf.Ajax.requestEx({
            ...
            if(response.success){  
                panel= new Wtf.account.consolidationPNLReportTab({
                    id:'consolidationCustomPNLReportTab',
                    layout:'fit',
                    border: false,
                    tabTip : WtfGlobal.getLocaleText("acc.consolidation.consolidationPNLtt"),
                    iconCls :'consolidationBalanceSheetIcon',
                    title:WtfGlobal.getLocaleText("acc.consolidation.consolidationPNL"),
                    closable:true,
...
Wtf.account.consolidationPNLReportTab = function (config){
    ...
    Wtf.account.consolidationPNLReportTab.superclass.constructor.call(this, config);
}

Wtf.extend(Wtf.account.consolidationPNLReportTab,Wtf.Panel,{
    onRender:function(config){
        Wtf.account.consolidationPNLReportTab.superclass.onRender.call(this, config);
        this.add({
            region: 'center',
            border: false,
    ...
    initComponent:function(config){
        Wtf.account.consolidationPNLReportTab.superclass.initComponent.call(this, config);
         this.createButton();
    ...
    createStore:function(recordsArray){
        ...
        this.store=new Wtf.data.Store({
            ...
            url: "ACCReports/getCustomConsolidationPNLReport.do",
            baseParams:{
...
//        WtfComMsgBox(29,4,true)
    ...
    onBeforeStoreLoad:function(store,obj){
        ...
        store.baseParams.periodView= false;// putting to get default BS
        store.baseParams.templateid=this.templateid
    ...
    createButton:function(){
        ...
        this.expButton=new Wtf.exportButton({
            ...
            filename: WtfGlobal.getLocaleText("acc.consolidation.consolidationPNL")+ "_v1",
            menuItem:{
                csv:true,
                pdf:true,
                rowPdf:false,
            ...
            get:Wtf.autoNum.consolidationCustomPNL,
        ...
        this.printButton=new Wtf.exportButton({
            ...
            filename: WtfGlobal.getLocaleText("acc.consolidation.consolidationPNL"),
        ...
        this.buttonArray.push(WtfGlobal.getLocaleText("acc.common.from"),this.startDate,WtfGlobal.getLocaleText("acc.common.to"),this.endDate,this.fetchBttn,this.expandCollpseButton,this.expButton,this.printButton);
    },
