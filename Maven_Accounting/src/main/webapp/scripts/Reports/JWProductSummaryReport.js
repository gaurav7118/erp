 ...
 *
 */
function JWPProductSummaryReport() {
    var mainTabId = Wtf.getCmp("as");
    var newTab = Wtf.getCmp("JWPProductSummaryReport");
    if (newTab == null) {
        newTab = new Wtf.account.JWPProductSummaryReport({
            layout: "fit",
            title: WtfGlobal.getLocaleText("JW Product Summary Report"),
            tabTip: WtfGlobal.getLocaleText("JW Product Summary Report"),
            closable: true,
            border: false,
            iconCls: getButtonIconCls(Wtf.etype.inventorysmr),
            id: "JWPProductSummaryReport"
        });
...
Wtf.account.JWPProductSummaryReport = function(config) {
    this.arr = [];
    ...
    Wtf.account.JWPProductSummaryReport.superclass.constructor.call(this, config);
}
Wtf.extend(Wtf.account.JWPProductSummaryReport, Wtf.Panel, {
    onRender: function(config) {
         ...
         */
        this.fetchStatement();
        Wtf.account.JWPProductSummaryReport.superclass.onRender.call(this, config);
    },
...
//            hidden:true,
        ...
        this.exportButton = new Wtf.exportButton({
            ...
            filename: "Job Work Product Summary" + "_v1",
            scope: this,
            menuItem: {
                csv: true,
                pdf: true,
            ...
            get: Wtf.autoNum.jwproductsummary
        });
...
//            disabled :true,
        ...
        this.bbarBtnArr.push('-', this.singlePrint);
        ...
        this.singlePrint.on("click", function() {
    ...
    createGrid: function() {
        this.Store = new Wtf.data.Store({
            url: "ACCJobWorkController/getJWProductSummaryReport.do",
