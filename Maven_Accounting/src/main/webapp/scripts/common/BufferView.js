 ...
 */
    ...
    /**
    * @class Wtf.ux.grid.BufferView
    * @extends Wtf.grid.GridView
    * A custom GridView which renders rows on an as-needed basis.
    */
    Wtf.ux.grid.BufferView = Wtf.extend(Wtf.grid.GridView, {
       /**
       ...
       initTemplates : function(){
          Wtf.ux.grid.BufferView.superclass.initTemplates.call(this);
          var ts = this.templates;
          // empty div to act as a place holder for a row
               ts.rowHolder = new Wtf.Template(
                  '<div class="x-grid3-row {alt}" style="{tstyle}"></div>'
          );
          ts.rowHolder.disableFormats = true;
          ts.rowHolder.compile();

          ts.rowBody = new Wtf.Template(
       ...
       getStyleRowHeight : function(){
          return Wtf.isBorderBox ? (this.rowHeight + this.borderHeight) : this.rowHeight;
       },
       ...
       syncScroll: function(){
          Wtf.ux.grid.BufferView.superclass.syncScroll.apply(this, arguments);
          this.update();
       },
       ...
       update: function(){
          if (this.scrollDelay) {
             if (!this.renderTask) {
                this.renderTask = new Wtf.util.DelayedTask(this.doUpdate, this);
             }
       ...
       clean : function(){
          if(!this.cleanTask){
             this.cleanTask = new Wtf.util.DelayedTask(this.doClean, this);
          }
