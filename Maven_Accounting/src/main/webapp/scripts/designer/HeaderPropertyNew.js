 ...
 * and open the template in the editor.
 */
Ext.HeaderWinNew = function (config) {
    Ext.apply(this, {
//        frame: true,
    ...
    Ext.HeaderWinNew.superclass.constructor.call(this, config)
}
...
Ext.ValignStore = Ext.create('Ext.data.Store', {
    fields: ['position', 'name'],
    data: [
        {
            "position": "top",
...
Ext.proppanel = Ext.extend(Ext.HeaderWinNew, Ext.Panel, {
