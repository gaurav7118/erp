...
Wtf.account.PackingDoListPanel=function(config){	
    ...
    Wtf.account.PackingDoListPanel.superclass.constructor.call(this,config);
    this.addEvents({
        'update':true
    });
}

Wtf.extend(Wtf.account.PackingDoListPanel,Wtf.account.ClosablePanel,{
    autoScroll: true,
    bodyStyle: {
    ...
    onRender:function(config){                
        ...
        Wtf.account.PackingDoListPanel.superclass.onRender.call(this, config);
        this.initForClose();   
        if( this.isEdit ){
    ...
    initComponent:function(config){
        Wtf.account.PackingDoListPanel.superclass.initComponent.call(this,config);
        ...
        this.Number=new Wtf.form.NumberField({
        ...
        var itemArr={};
        itemArr = [this.Name,this.Number,this.billDate,this.portOfLoading,this.portOfDischarge,this.vessel,this.incoterms];
    ...
    save:function(){
        ...
        if(this.NorthForm.getForm().isValid()){
            ...
            this.ajxurl = "";
            if(this.businessPerson=="Customer") {
                this.ajxurl = "ACCInvoice/savePackingDoList.do";            
            } 
            ...
            for(var i=0;i<prodLength;i++){ 
                ...
                var packingdetails=this.Grid.getStore().getAt(i).data['packingdetails'];
...
Wtf.extend(Wtf.account.PackingDoListGrid,Wtf.grid.EditorGridPanel,{
    ...
    updateRow:function(obj){
        if(obj!=null){            
            ...
            if(rec.data["dquantity"]<rec.data["shipquantity"]){
