...
<%
    ...
    try {
        ...
        if (moduleName != null && moduleName.equals("goodsreceiptorder")) {
            path = "/CommonFunctions/updateGoodsReceiptOrderAmount.do";
        } else if (moduleName != null && moduleName.equals("deliveryorder")) {
            path = "/CommonFunctions/updateDeliveryOrderAmount.do";
        }
