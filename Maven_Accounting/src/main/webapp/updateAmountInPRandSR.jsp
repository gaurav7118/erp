<%-- 
    Document   : updateAmountInPRandSR
    Created on : Nov 8, 2015, 10:37:18 AM
    Author     : krawler
--%>
...
<%
    ...
    try {
        ...
        String requestedURL = url.substring(0, url.indexOf(servletBase)) + "/CommonFunctions/updateAmountInPRandSR.do";
