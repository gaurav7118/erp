<%-- 
    ...
    Author     : krawler
    Purpose: Update cheque End number of cheque sequence format whose cheque end number equals to zero.
--%>
...
//                        
                            String selectExistingSeqFormatQuery = "select id,numberofdigits from chequesequenceformat where company=? and chequeEndNumber=0";
...
//                                    name +="0";
                                ...
                                String addChequeSequenceFormatQuery = "update chequesequenceformat set chequeEndNumber=? where id=? and company=?";
                                PreparedStatement insertstmt = conn.prepareStatement(addChequeSequenceFormatQuery);
//                                insertstmt.setString(1, name);
                                insertstmt.setLong(1, chequeEndNumber);
