...
<%
    ...
    try {
        ...
        String port = "3306";
        String dbName = request.getParameter("dbname");//"accounting_fasten";
...
//        }
        ...
        while (rs.next()) {
            ...
            String InvLocId = "4028818a4e05e809014e1a0d60020105"; //set location
            
            String InvWarId = "4028818a50d216f00150f58192e74b8f"; //set warehouse
           

            String productid = "", productname = "";
            String queryproduct = "select id,name from product where company=? AND productid='PIA-501625HN-RG'"; //only for product having productid=PIA-501625HN-RG
            ...
            while (rsp.next()) {
                ...
                if (!StringUtil.isNullOrEmpty(productid)) {
                    ...
                    String queryForupdate = "update product set islocationforproduct='T',iswarehouseforproduct='T',location=?,warehouse=? where id=? and company=? ";//activate warehouse,location,islocationforproduct andiswarehouseforproduct 
                    PreparedStatement stmtforUpdate = conn.prepareStatement(queryForupdate);
   ...
   /**
            ...
            while (rs1.next()) {
                ...
                smd.execute();
                smd.close();
                System.out.println("While 2 completed ");
            }
            ...
            while (rs2.next()) {
                ...
                smd.execute();
                smd.close();
                System.out.println("While 3 completed ");
            }
             ...
             * **********************************
             */
            String productBuildQry = "SELECT pb.*,product.unitOfMeasure from productbuild pb INNER JOIN product ON product.id=pb.product where pb.company=? and product.id='ff808081556dffc0015599fe097d4d3f'";
            ...
            while (rs3.next()) {
                ...
                String productBuildDetailQry = "SELECT pbd.*,p.unitOfMeasure,pb.entrydate,pb.refno from pbdetails pbd  INNER JOIN productbuild pb ON pb.id = pbd.build INNER JOIN product p ON p.id=pbd.aproduct where pbd.build= ? and pb.product='ff808081556dffc0015599fe097d4d3f'";
                ...
                while (rsdtl.next()) {
                    ...
                    System.out.println("While 4 completed ");
            }
