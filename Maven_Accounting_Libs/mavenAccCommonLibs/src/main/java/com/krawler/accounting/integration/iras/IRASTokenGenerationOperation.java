 ...
 * @author krawler
 */
public class IRASTokenGenerationOperation extends IRASIntegrationUtil implements IntegrationOperation {
...
//            String restServiceUrl = IntegrationConstants.iras_Integration_Common_Url;
            ...
            restServiceUrl+=IntegrationConstants.iras_TokenGeneration_context;
            ...
            String payload=getPayloadForTokenGeneration(requestJobj,integrationAccountDetails);
            if(!payload.isEmpty()){
