 ...
 * @author krawler
 */
public class IRASTransactionListingOperation extends IRASIntegrationUtil implements IntegrationOperation {
...
//            String restServiceUrl = IntegrationConstants.iras_Integration_Common_Url;
            ...
            restServiceUrl+=IntegrationConstants.iras_TransactionListing_context;
            Map<String, String> headersMap = createHeadersMap(integrationAccountDetails);
            headersMap.put("access_token", requestJobj.optString("access_token"));
