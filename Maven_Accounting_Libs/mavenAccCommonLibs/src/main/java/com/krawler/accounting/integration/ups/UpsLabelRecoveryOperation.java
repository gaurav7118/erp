 ...
 * @author krawler
 */
public class UpsLabelRecoveryOperation extends UpsIntegrationUtil implements IntegrationOperation {
    @Override
    public JSONObject executeOperation (JSONObject requestJobj, JSONObject integrationAccountDetails) throws JSONException, ServiceException, AccountingException {
        ...
        try {
            ...
            restServiceUrl += IntegrationConstants.labelRecoveryContext;
            Map<String, String> headersMap = createHeadersMap();
            Map<String, Object> otherReqPropertiesMap = createOtherReqPropertiesMap();
            JSONObject payloadJson = getPayloadForLabelRecovery(requestJobj, integrationAccountDetails);
            ...
            Logger.getLogger(UpsLabelRecoveryOperation.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        }
        return returnJobj;
    }
