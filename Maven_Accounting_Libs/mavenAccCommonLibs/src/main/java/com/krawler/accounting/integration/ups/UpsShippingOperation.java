 ...
 * @author krawler
 */
public class UpsShippingOperation extends UpsIntegrationUtil implements IntegrationOperation {
    @Override
    public JSONObject executeOperation (JSONObject requestJobj, JSONObject integrationAccountDetails) throws JSONException, ServiceException, AccountingException {
        ...
        try {
            ...
            JSONObject payloadJson = getPayloadForShipping(requestJobj, integrationAccountDetails);
            ...
            Logger.getLogger(UpsShippingOperation.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        }
        return returnJobj;
    }
