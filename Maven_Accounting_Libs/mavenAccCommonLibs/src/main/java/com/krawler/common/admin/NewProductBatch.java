...
public class NewProductBatch {
    ...
    private boolean isForconsignment;  //as it is consignment do so it should not be available for normal salesreturn so we are making this flag true
