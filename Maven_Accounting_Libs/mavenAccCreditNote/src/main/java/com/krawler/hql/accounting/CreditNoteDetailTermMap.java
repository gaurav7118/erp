...
/**
 * This is used to store line level term mapping against creditNoteTaxEntry.
 *
 * @author swapnil.khandre
 */
public class CreditNoteDetailTermMap {

    private String id;
    private String creditNoteTaxEntry;
    ...
    private CreditNoteAgainstVendorGst creditnotedetail;
    ...
    public String getCreditNoteTaxEntry() {
        return creditNoteTaxEntry;
    }

    public void setCreditNoteTaxEntry(String creditNoteTaxEntry) {
        this.creditNoteTaxEntry = creditNoteTaxEntry;
    }

    public CreditNoteAgainstVendorGst getCreditnotedetail() {
        return creditnotedetail;
    }

    public void setCreditnotedetail(CreditNoteAgainstVendorGst creditnotedetail) {
