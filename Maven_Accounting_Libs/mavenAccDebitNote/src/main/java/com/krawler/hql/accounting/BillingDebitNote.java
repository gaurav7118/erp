...
public class BillingDebitNote {
    ...
    private Set<BillingDebitNoteDiscount> discounts;
    private Set<BillingDebitNoteDetail> rows;
    ...
    public Set<BillingDebitNoteDiscount> getDiscounts() {
        return discounts;
    }

    public void setDiscounts(Set<BillingDebitNoteDiscount> discounts) {
    ...
    public Set<BillingDebitNoteDetail> getRows() {
        return rows;
    }

    public void setRows(Set<BillingDebitNoteDetail> rows) {
        this.rows = rows;
    }
