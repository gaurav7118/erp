 ...
 * @author krawler
 */
public class DebitNoteAgainstCustomerGst  implements Comparable<DebitNoteAgainstCustomerGst> {
    ...
    private GoodsReceiptDetail grdetail;
     ...
     */
    @Override
    public int compareTo(DebitNoteAgainstCustomerGst o) {
        int srNo = o.getSrno();
        if (this.srno == srNo) {
            return 0;
    ...
    /**
     * @param cidetails the cidetails to set
     */
    ...
    public GoodsReceiptDetail getGrdetail() {
        return grdetail;
    }

    public void setGrdetail(GoodsReceiptDetail grdetail) {
