...
public class BillingInvoiceDetail {
    ...
    private BillingSalesOrderDetail salesOrderDetail;
    ...
    public BillingSalesOrderDetail getSalesOrderDetail() {
        return salesOrderDetail;
    }

    public void setSalesOrderDetail(BillingSalesOrderDetail salesOrderDetail) {
