...
public class PurchaseOrderDetail {
    ...
    private PurchaseOrderDetailsCustomData poDetailCustomData;
    ...
    public PurchaseOrderDetailsCustomData getPoDetailCustomData() {
        return poDetailCustomData;
    }

    public void setPoDetailCustomData(PurchaseOrderDetailsCustomData poDetailCustomData) {
        this.poDetailCustomData = poDetailCustomData;
    }
