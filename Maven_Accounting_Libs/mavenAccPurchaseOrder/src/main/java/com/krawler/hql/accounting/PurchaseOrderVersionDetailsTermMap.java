 ...
 * @author krawler
 */
public class PurchaseOrderVersionDetailsTermMap {

    private String ID;
    private PurchaseOrderVersionDetails povdetails;
    ...
    public PurchaseOrderVersionDetails getPovdetails() {
        return povdetails;
    }

    public void setPovdetails(PurchaseOrderVersionDetails povdetails) {
        this.povdetails = povdetails;
    }
