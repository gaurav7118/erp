 ...
 * @author Rahul Bhawar
 */
public class SGEDetailsTermMap {

    private String id;
    private SecurityGateDetails sgedetails;   
    ...
    public SecurityGateDetails getSgedetails() {
        return sgedetails;
    }

    public void setSgedetails(SecurityGateDetails sgedetails) {
        this.sgedetails = sgedetails;
    }
