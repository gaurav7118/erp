 ...
 *
 */
public class VendorQuotationVersionDetail {

    private String ID;
    private int srno;
    private VendorQuotationVersion quotationversion;
    ...
    private VendorQuotationVersionDetailCustomData quotationDetailCustomData;
    ...
    public VendorQuotationVersionDetailCustomData getQuotationDetailCustomData() {
        return quotationDetailCustomData;
    }

    public void setQuotationDetailCustomData(VendorQuotationVersionDetailCustomData quotationDetailCustomData) {
        this.quotationDetailCustomData = quotationDetailCustomData;
    }

    public VendorQuotationVersion getQuotationversion() {
        return quotationversion;
    }

    public void setQuotationversion(VendorQuotationVersion quotationversion) {
