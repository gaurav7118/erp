...
public class QuotationVersion {
    ...
    private String memo;
    private Set<QuotationVersionDetail> rows;
    ...
    private QuotationVersionCustomData quotationCustomData;
    ...
    public Set<QuotationVersionDetail> getRows() {
        return rows;
    }

    public void setRows(Set<QuotationVersionDetail> rows) {
        this.rows = rows;
    }
    ...
    public QuotationVersionCustomData getQuotationCustomData() {
        return quotationCustomData;
    }

    public void setQuotationCustomData(QuotationVersionCustomData quotationCustomData) {
