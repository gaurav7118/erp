 ...
 *
 */
public class QuotationVersionDetail {

    private String ID;
    private int srno;
    private QuotationVersion quotationversion;
    ...
    private QuotationVersionDetailCustomData quotationDetailCustomData;
    ...
    public QuotationVersion getQuotationversion() {
        return quotationversion;
    }

    public void setQuotationversion(QuotationVersion quotationversion) {
    ...
    public QuotationVersionDetailCustomData getQuotationDetailCustomData() {
        return quotationDetailCustomData;
    }

    public void setQuotationDetailCustomData(QuotationVersionDetailCustomData quotationDetailCustomData) {
