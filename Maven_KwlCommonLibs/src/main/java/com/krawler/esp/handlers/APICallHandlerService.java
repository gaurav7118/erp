...
public interface APICallHandlerService {
    ...
    public JSONObject restDeleteMethod(String endpoint, String inputData) throws JSONException, ServiceException;
    ...
    public JSONObject restGetMethod(String endpoint, String inputData) throws JSONException, ServiceException;
    ...
    public JSONObject restPostMethod(String endpoint, String inputData) throws JSONException, ServiceException;
    ...
    public ByteArrayOutputStream restPostMethodForBAOS(String endpoint, String inputData) throws JSONException, MalformedURLException, IOException ;
